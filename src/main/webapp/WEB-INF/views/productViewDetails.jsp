...
<body ng-app="addToCartApp">
    <div ng-controller="addToCartCtrl">
        <a href="javascript:void(0)"  class="btn btn-primary" ng-click="addItemToCart(${product.product_id})">Add To kart </a>
    ...
    cartApp.controller("addToCartCtrl", function ($scope, $http){
        ...
        $scope.removeItemFromCart = function (itemId) {
            $http.put('http://localhost:8080/shoeclue/usercart/cart/removeItem/'+itemId).success(function (data) {
