...
<div class="span9 margin-left" ng-app="addToCartApp">
        ...
        <table class="table table-bordered table-striped fs13" >
		  <thead>
			  <tr>
				...
				<th>Product</th>
				<th class="width110">Product Image</th>
				<th >Unit Price</th>
				<th>Quantity</th>
				<th>Price(in Rs.)</th>
				<th>id</th>
		  ...
		  <div class="span3">
             <a href="<spring:url value="/" />" class="btn btn-primary center">Continue Shopping</a>
              <a href="<spring:url value="/order/${cartId}"/>"
                   class="btn btn-success center"><span class="glyphicon-shopping-cart glyphicon"></span> Check out</a>
...
<script src="http://ajax.googleapis.com/ajax/libs/angularjs/1.4.2/angular.min.js"></script>
    ...
    cartApp.controller("addToCartCtrl", function ($scope, $http){
        ...
        $scope.removeItemFromCart = function (itemId) {
            ...
            $http.put('http://localhost:8080/e-shop/usercart/cart/removeItem/'+itemId).success(function (data) {
        ...
        $scope.addItemToCart = function (itemId) {
        	 alert("test");
            $http.put('http://localhost:8080/e-shop/usercart/cart/addItem/'+itemId).success(function () {
        ...
        $scope.refreshCartItems = function () {
            ...
            $http.get('http://localhost:8080/e-shop/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
               $scope.cart=data;
            });
        };
        ...
        $scope.clearCartItems = function () {
        	alert("clear cart items called")
        	$http['delete']('http://localhost:8080/e-shop/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
        };
    });
</script>
</body>
