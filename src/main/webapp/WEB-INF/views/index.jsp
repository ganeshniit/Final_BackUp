  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
		   ...
		   <li> <button type="button" class="btn btn-primary btn-s" style="background-color:red">e-Shop</button></li>
		    <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/mac.jpg" alt="Chania" style="width:800px; height:400px">
      ...
      <div class="item">
        <img src="resources/images/mens.jpg" alt="Chania" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something"> -->
      ...
      <div class="item">
        <img src="resources/images/kids.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!--  <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
      ...
      <div class="item">
        <img src="resources/images/game.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
...
<div>
 <center><h3>Featured Shoes</h3></center>
<hr></hr>
</div>
<div class="container">
